# Data Discovery and Observability tools

This repository contains a curated list of some data documentation and observability platforms that help you discover, manage, and observe data in your organization. 
